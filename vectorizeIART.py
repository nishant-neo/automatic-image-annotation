...
#        print child.text
    ...
    for line in comm_file:
        if 'DESCRIPTION' in line:
            ...
            cline = [x.decode('unicode_escape').encode('utf-8') for x in cline]
            #print cline
            cline = cline[1:-2]
...
comm_kmeans = KMeans(n_clusters = 25).fit(comm_imp_top_doc)
...
file_test = open('./test/sift.pickle','rb')
